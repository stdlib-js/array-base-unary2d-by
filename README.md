...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-base-unary2d-by/tags). For example,

```javascript
unary2dBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-unary2d-by@v0.2.3-umd/browser.js' )
```
