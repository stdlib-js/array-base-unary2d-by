...
```javascript
import unary2dBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-unary2d-by@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-unary2d-by/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-unary2d-by/actions/workflows/test.yml?query=branch:v0.2.3
